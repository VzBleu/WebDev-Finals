                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="updateProcess.php">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-custom" name="newPrice"
                                    id="newPrice" placeholder="New Price" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-custom" name="newWins" id="newWins"
                            ...
                            <button type="submit" class="btn btn-primary btn-block btn-custom">Update</button>
                        </form>
                    </div>
                </div>
            </div>
